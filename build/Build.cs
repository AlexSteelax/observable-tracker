    ...
    internal Target Pack => _ => _
        ...
        .Executes(() =>
        {
            DotNetPack(settings => settings
                .SetProject(Solution.GetProject("Steelax.ObservableTracker"))
                .SetConfiguration(Configuration)
                .EnableNoBuild()
                .EnableNoRestore()
                .SetAuthors("AlexSteelax")
                .SetPackageProjectUrl("https://github.com/AlexSteelax/observable-tracker")
                .SetRepositoryUrl("https://github.com/AlexSteelax/observable-tracker.git")
